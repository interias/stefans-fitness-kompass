...
## 8.1 Krafttraining als Basis nutzen
...
## 8.2 Regelmäßigkeit schlägt Perfektion
...
## 8.3 Ziel und Spezifität klären
...
### 8.3.1 Riskante Ausführung früh aussortieren

Riskant ist selten eine Übung allein. Riskant wird Training vor allem dann, wenn Last, Bewegungsumfang, Geschwindigkeit, Ermüdung und technisches Können nicht zusammenpassen. Reviews zu Gewichtheben und Powerlifting ordnen das Verletzungsrisiko pro Trainingsstunde eher niedrig ein, nennen aber wiederholt unteren Rücken, Knie und Schulter als häufige Problemregionen (<a href="https://pubmed.ncbi.nlm.nih.gov/39650568/">Tung et al. 2024</a>; <a href="https://pubmed.ncbi.nlm.nih.gov/27328853/">Keogh und Winwood 2017</a>). Praktisch heißt das: schwere Übungen nicht meiden, aber Fehler früh aussortieren, bevor sie mit mehr Gewicht normal werden.

Die folgende Liste ist keine Diagnosetabelle. Sie zeigt typische Muster, bei denen der Trainingsreiz schnell schlechter wird und die Folgekosten steigen können.

| Beispiel | Fehlerbeschreibung | Mögliche Auswirkung | Möglicher Reha-Aufwand, wenn es kippt |
| --- | --- | --- | --- |
| Kniebeuge oder Beinpresse | Tiefe wird über einrundenden unteren Rücken, abhebende Fersen, einknickende Knie oder unkontrolliertes Abfedern erzwungen | weniger Zielmuskelreiz, mehr Stress für unteren Rücken, Hüfte oder Knie | oft erst Lastreduktion und Technikaufbau; bei Zerrung, Verstauchung oder stärkerer Reizung eher Wochen statt Tage |
| Kreuzheben, RDL oder Good Morning | Last wird vom Boden gerissen, die Hantel wandert weit vom Körper weg, Rumpfspannung bricht unter Ermüdung weg | akute Rücken-, Hüft- oder hintere Oberschenkelreizung; Technik verschlechtert sich oft von Satz zu Satz | Hinge-Muster muss meist mit leichter Last neu aufgebaut werden; ausstrahlender Schmerz, Taubheit oder Kraftverlust gehören fachlich abgeklärt |
| Bankdrücken, Dips oder schwere Flys | Schulter gleitet nach vorn, Ellenbogen stehen sehr weit außen, die Hantel wird auf der Brust abgefedert oder ohne Ablagen/Spotter überschätzt | vordere Schulter, Brustansatz oder Ellenbogen können überlastet werden; bei freien Hanteln steigt zusätzlich das Unfallrisiko | leichte Reizung: Übung tauschen und Druckvolumen senken; bei Sehnen- oder Schulterbeschwerden häufig 6-12+ Wochen progressiver Aufbau statt ein paar Tage Pause |
| Überkopfdrücken, Nackendrücken, Upright Row mit engem Griff | fehlende Schulterbeweglichkeit wird über Hohlkreuz, Druck in den Nacken oder schmerzhafte Innenrotation kompensiert | Schulter, Nacken oder unterer Rücken übernehmen Arbeit, die eigentlich kontrolliert aus Schulterblatt und Rumpf kommen sollte | oft lohnt der Wechsel auf Kurzhantel, Landmine Press, Seitheben oder neutralen Griff; anhaltender Schulterschmerz braucht eher systematische Rehabilitation |
| Latzug in den Nacken, Klimmzug oder Kipping-Variante | Kopf wird nach vorn geschoben, Schultern ziehen hoch, Schwung ersetzt Zugkraft | Schulter und Ellenbogen bekommen viel Bewegung, aber wenig kontrollierbaren Zielreiz | zuerst strikte Wiederholungen, Tempo und Schulterkontrolle aufbauen; dynamische Varianten erst, wenn die Basis reproduzierbar ist |
| Sprünge, olympische Varianten oder schwere Zirkel | hohe Geschwindigkeit wird unter Müdigkeit trainiert, Landungen werden laut oder seitlich instabil, Technik bricht im Zeitdruck weg | höheres Risiko für Umknicken, Knie- oder Rückenstress; Power-Training verliert seinen Zweck | meist Volumen senken, Pausen verlängern und Wiederholungen stoppen, sobald Landung oder Position kippen |

Als grobe Orientierung: Viele einfache Zerrungen und Verstauchungen fühlen sich nach etwa zwei Wochen besser an, schwere Fälle können Monate brauchen; intensive Belastung sollte oft länger zurückgestellt werden (<a href="https://www.nhs.uk/conditions/sprains-and-strains/">NHS 2024</a>). Weichteilverletzungen und Überlastungsprobleme können trotz richtiger Behandlung länger dauern, besonders wenn wiederholt zu früh belastet wird (<a href="https://orthoinfo.aaos.org/en/diseases--conditions/sprains-strains-and-other-soft-tissue-injuries/">AAOS o. J.</a>). Schulter- und Sehnenprobleme werden häufig über progressive Belastung und Kriterien für die Rückkehr zum Sport gesteuert, nicht über ein fixes Kalenderdatum (<a href="https://pubmed.ncbi.nlm.nih.gov/40165544/">Desmeules et al. 2025</a>). Warnsignale sind stechender oder ausstrahlender Schmerz, Taubheit, Kribbeln, Instabilität, deutliche Schwellung, Bluterguss, Formveränderung oder Beschwerden, die trotz Entlastung schlechter werden.

## 8.4 Hypertrophie verstehen: mTORC1, Spannung und Proteinaufbau
...
## 8.5 Technik als Reizsteuerung verstehen
...
## 8.6 Progression planen

Training muss über Zeit anspruchsvoller werden: mehr Wiederholungen, mehr Gewicht, bessere Technik, größerer Bewegungsumfang, mehr Sätze oder kürzere Pausen (<a href="https://pubmed.ncbi.nlm.nih.gov/19204579/">ACSM 2009</a>). Ein Trainingstagebuch macht diese Progression sichtbar; die konkrete Logbuchstruktur steht in [04 Tracking und Messung](04-tracking.md).

### 8.6.1 Progression in der Realität

Progression sieht im Logbuch selten wie eine glatte Linie aus. Ein typischer Hypertrophieblock arbeitet mit einem Wiederholungsbereich, zum Beispiel 3 Sätze mit 8-10 Wiederholungen. Wenn 60 kg Bankdrücken in Woche 1 mit 8/8/7 Wiederholungen bei etwa 2 RIR starten, ist Fortschritt in Woche 2 vielleicht 8/8/8, später 9/8/8 und erst nach mehreren Einheiten 10/10/10. Dann steigt die Last auf 62,5 kg, die Wiederholungen fallen wieder etwas, und der nächste kleine Zyklus beginnt. Das ist normale Progression, kein Rückschritt.

Nicht jeder Fortschritt ist mehr Gewicht. Gerade bei Einsteigern und neuen Übungen zählen auch stabilerer Bewegungsumfang, weniger Schwung, bessere Pausensteuerung, mehr Wiederholungen bei gleicher Last, weniger Ausweichbewegungen, bessere Wiederholbarkeit und ein höherer geschätzter 1RM bei gleicher Technik. Wenn zwei bis drei Wochen nichts steigt, ist das nicht automatisch ein Plateau. Zuerst Technik, Schlaf, Ernährung, Stress, Satznähe und Gesamtvolumen prüfen; erst danach Gewicht erzwingen, Sätze erhöhen oder die Übung wechseln.

| Trainingszeit mit konsistentem Plan | Typischer Kraftfortschritt | Typischer Muskelaufbau | Grenze |
| --- | --- | --- | --- |
| 0-3 Monate | schnelle Sprünge durch Technik, Koordination und Übungsroutine; Lasten oder Wiederholungen können oft wöchentlich steigen | erste sichtbare Änderungen sind möglich, aber Pump, Glykogen, Wasser und bessere Haltung mischen mit; echte Hypertrophie wird eher über mehrere Wochen bis Monate belastbar sichtbar (<a href="https://pubmed.ncbi.nlm.nih.gov/21409401/">DeFreitas et al. 2011</a>; <a href="https://pubmed.ncbi.nlm.nih.gov/29282529/">Damas et al. 2018</a>) | Startwerte verzerren Prozentangaben stark |
| Jahr 1 | größter Fortschrittsblock; viele Übungen lassen sich noch regelmäßig über Wiederholungen oder kleine Lastsprünge steigern | bei guter Ernährung und regelmäßigem Training können mehrere kg fettfreie Masse dazukommen; nicht jede Gewichtszunahme ist Muskelmasse | Techniklernen, Körpergewicht und Messmethode erklären viel |
| 2 Jahre | Fortschritt wird blockweiser; nicht jede Woche bringt einen PR | Muskelzuwachs bleibt möglich, wird aber deutlich langsamer als am Anfang | Programme müssen besser zu Alltag und Erholung passen |
| 3 Jahre | viele sind im Zwischenbereich: einzelne Lifts steigen noch klar, andere brauchen Spezialisierung | kleine sichtbare Veränderungen entstehen eher über Monate als Wochen | Übungsauswahl, Schwachstellen und Volumensteuerung werden wichtiger |
| 5 Jahre | neue Bestleistungen sind realistisch, aber meist kleiner und seltener | jährlicher Muskelzuwachs kann klein sein; Erhalt, bessere Verteilung und Qualität werden wichtiger | schlechte Phasen, Verletzungen und Lebensstress zählen stärker |
| 10-15 Jahre | Fortschritt ist möglich, aber stark spezifisch: Technik, Körpergewicht, Spezialisierung und Übungsauswahl beeinflussen viel; Powerlifting-Daten zeigen, dass Kraft über viele Jahre weiter steigen kann (<a href="https://pubmed.ncbi.nlm.nih.gov/32865942/">Latella et al. 2020</a>; <a href="https://pubmed.ncbi.nlm.nih.gov/35019902/">Latella et al. 2022</a>) | große Muskelzuwächse sind bei Natural-Trainierenden nach vielen konsistenten Jahren selten; kleine Verbesserungen und Erhalt sind trotzdem wertvoll | Wettkampfdaten und Benutzerberichte sind keine Vorhersage für einzelne Personen |

Glaubwürdige Benutzerberichte sind deshalb nur als Plausibilitätscheck sinnvoll. Hilfreich sind sie, wenn sie Trainingslog, Körpergewicht, Zeitraum, Technikstandard, Fotos oder Messungen, Pausen- oder Verletzungshistorie und Substanzstatus offenlegen. Einzelne Vorher-nachher-Posts ohne Kontext sind schwach; besser sind langfristige Logs oder Datensätze mit vielen wiederholten Messpunkten. Selbst dann bleibt die Übertragbarkeit begrenzt.

## 8.7 Belastung steuern: Volumen, RIR, Wiederholungen und Pausen
...
## 8.8 Werkzeuge, Bewegungsmuster und Prioritäten wählen
...
Welche Bewegung welche Muskulatur belastet und wie man Übungen dafür auswählt, wird in [09 Biomechanik und Übungsauswahl](09-biomechanik-uebungsauswahl.md) praktisch eingeordnet.

## 8.9 Regeneration als Grenze einplanen
...
## 8.10 Trainingspläne und Split-Programme
...
Ausdauer wird in [10 Ausdauertraining](10-ausdauertraining.md) getrennt beschrieben. Die Wochenstruktur verbindet beide Reize trotzdem, weil Krafttraining, Laufen, Schlaf und Alltag in der Praxis um dieselbe Regeneration konkurrieren.

### 8.11.1 Minimal-Woche
...
## 8.12 Kontrolle: Trainingslog und Schmerzregel

Kontrolle schließt den Planungsbogen: Das Logbuch hält die wichtigsten Trainingsdaten fest; [04 Tracking und Messung](04-tracking.md) beschreibt dafür die einfache Vorlage. Die Schmerzregel verhindert, dass Ehrgeiz Technik und Belastbarkeit überfährt.
