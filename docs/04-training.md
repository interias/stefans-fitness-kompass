...
## 4.3 Hypertrophie verstehen: mTORC1, Spannung und Proteinaufbau
...
mTORC1 ist wichtig, aber nicht der einzige Mechanismus. Praktisch zählt, dass Training, Protein/Aminosäuren, Energieverfügbarkeit und Erholung zusammen dafür sorgen, dass Muskelproteinsynthese über Zeit den Muskelproteinabbau übersteigt (<a href="https://jissn.biomedcentral.com/articles/10.1186/s12970-017-0177-8">ISSN 2017a</a>; <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC12927080/">Van Every et al. 2025</a>).
...
Gute Hypertrophiearbeit fühlt sich oft hart an, muss aber nicht jedes Mal zerstörend sein. Ziel sind kontrollierte Wiederholungen, ausreichend harte Arbeitssätze, planbare Progression und genug Regeneration.

<p align="center">
  <img src="../assets/visuals/fitness-kompass-training-hypertrophie-signalweg.png" alt="Fitness-Kompass Training Hypertrophie Signalweg" width="100%">
</p>

*Abbildung: Muskelaufbau ist ein wiederholbarer Ablauf aus mechanischer Spannung, Signalwegen, Proteinaufbau und Erholung.*

## 4.4 Krafttraining als Basis nutzen
...
## 4.6 Hart trainieren, aber steuerbar bleiben

Muskelaufbau braucht Nähe zum Muskelversagen, aber nicht jeder Satz muss maximal sein. Reps in Reserve (RIR) ist ein wertvolles Werkzeug, um harte Sätze reproduzierbar zu steuern; viele Arbeitssätze funktionieren gut mit etwa 1-3 Wiederholungen im Tank, während einzelne Isolationssätze gelegentlich näher ans Limit gehen können (<a href="https://pubmed.ncbi.nlm.nih.gov/36334240/">Refalo et al. 2023</a>).

**Satzpausen:** Pausen sind kein Leerlauf, sondern sichern Leistung, Technik und Trainingsvolumen. Für schwere Grundübungen sind längere Pausen oft sinnvoll; bei Isolationsübungen, Maschinen oder zeitsparenden Blöcken können kürzere Pausen funktionieren, solange die Zielmuskulatur weiterhin sauber belastet wird (<a href="https://www.frontiersin.org/journals/sports-and-active-living/articles/10.3389/fspor.2024.1429789/full">Singer et al. 2024</a>).

**Dichte Methoden:** EMOM ist kein eigener Hypertrophie-Mechanismus, sondern ein Zeitrahmen: Es funktioniert, wenn Last, Wiederholungen, Technik und Nähe zum Versagen weiterhin passen. Harte Drop-Sätze funktionieren ebenfalls und können Zeit sparen, erzeugen aber viel Ermüdung; sie passen eher ans Ende einer Übung, auf Maschinen oder bei Isolationsübungen (<a href="https://pubmed.ncbi.nlm.nih.gov/37523092/">Sødal et al. 2023</a>; <a href="https://pubmed.ncbi.nlm.nih.gov/34125411/">Iversen et al. 2021</a>).
...
## 4.8 Beine, Rücken und Griffkraft ernst nehmen

Für Alltag, Haltung, Laufen, OCR/Spartan und langfristige Robustheit sind Beine, Rücken, hintere Kette und Griffkraft zentral. Rows, Pull-downs/Pull-ups, RDLs, Beinbeuger, Carries, Hängen, Waden und Core sollten deshalb regelmäßig vorkommen.

## 4.9 Ausdauer ergänzen
...
### 4.9.1 Was Cardio im Körper verbessert
...
<p align="center">
  <img src="../assets/visuals/fitness-kompass-training-vo2max-sauerstoffkette.png" alt="Fitness-Kompass Training VO2max Sauerstoffkette" width="100%">
</p>
...
### 4.9.5 Drei robuste HIIT-Vorlagen
...
<p align="center">
  <img src="../assets/visuals/fitness-kompass-training-cardio-intensitaetsmix.png" alt="Fitness-Kompass Training Cardio Intensitaetsmix" width="100%">
</p>

*Abbildung: Ausdauertraining wird robuster, wenn lockere Basisarbeit und wenige harte Reize bewusst getrennt werden.*

## 4.10 Regeneration einplanen

Schlaf, Ernährung, Pausen, Deloads und Stressmanagement sind Teil des Trainingsplans. Wenn Leistung, Stimmung und Schlaf mehrere Wochen schlechter werden, sollte zuerst Belastung geprüft, Volumen reduziert und Schlaf priorisiert werden.

## 4.11 Spezifität beachten

Man wird gut in dem, was man trainiert. Bodybuilding, Marathon, Spartan Race, Kraftwerte und allgemeine Gesundheit brauchen unterschiedliche Schwerpunkte. Erst das Ziel definieren, dann Training danach sortieren: Muskelaufbau, Kraft, Fettverlust, Laufen, OCR oder Gesundheit.

---

## 4.12 Trainingsziele: Kraft, Explosivität und Mobilität

Hypertrophie, Maximalkraft, Powerlifting, Explosivität und Mobilität überschneiden sich, sind aber nicht dasselbe Ziel. Je konkreter das Ziel, desto spezifischer müssen Übungsauswahl, Intensität, Pausen, Technik und Progression werden.
...
Erst Ziel klären, dann Methode wählen: Wer stärker werden will, braucht schwere spezifische Lifts. Wer schneller oder explosiver werden will, braucht frische, schnelle Wiederholungen. Wer beweglicher werden will, braucht regelmäßig trainierten Bewegungsumfang. Alles gleichzeitig maximal zu priorisieren führt schnell zu schlechterer Erholung.

---

## 4.13 Trainingspläne und Split-Programme

Ein Split ist nur die Organisation der Trainingswoche. Er baut nicht automatisch mehr Muskeln auf. Entscheidend bleiben Wochenvolumen, Progression, Technik, Nähe zum Muskelversagen, Satzpausen, Übungsauswahl und Regeneration.
