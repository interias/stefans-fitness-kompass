...
Subject/style: premium medical-anatomy editorial illustration mixed with realistic 3D detail, ultrarealistic muscle texture, educational, precise, calm, high-end GitHub documentation visual. Deltoid in muted red and rose tones with subtle tonal separation between the three heads, bones slate-gray/ivory, rotator cuff secondary and desaturated.
Composition/framing: landscape 16:9, shoulder joint centered, deltoid cap prominent, clavicle/acromion/scapular spine origins readable, deltoid tuberosity on humerus visible, generous margins. Use subtle non-text anchor dots or fine callout lines only if needed. No labels.
...
Strict constraints: anatomically plausible deltoid origins and insertion, clear three-part fiber direction, no duplicate shoulders, no missing humeral head, no detached rotator cuff, no impossible transparent overlays, no readable text, no letters, no numbers, no labels, no pseudo-text, no watermark, no logo, no gore, no blood, no organs, no exposed viscera, no injury, no surgery, no needles, no dramatic medical panic imagery, no bodybuilder posing, no aggressive bodybuilding aesthetic, no product placement, no stock-photo look.
