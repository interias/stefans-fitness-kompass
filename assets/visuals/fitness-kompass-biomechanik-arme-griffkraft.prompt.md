...
Asset type: replacement inline anatomy visual for docs/05-biomechanik-uebungsauswahl.md, section 5.9 arms/forearms/grip, target aspect ratio 16:9, intended final size 1600x900 px
...
Subject/style: premium medical-anatomy editorial illustration mixed with realistic 3D detail, ultrarealistic muscle texture, educational, precise, calm, high-end GitHub documentation visual. Main muscles in muted red and rose tones, tendons ivory-white, bones slate-gray/ivory, secondary anatomy desaturated.
Composition/framing: landscape 16:9, two balanced arm views with generous margins, shoulder-to-hand visible in both views, elbow and forearm tendon paths clear. Use subtle non-text anchor dots or fine callout lines only if needed. No labels.
Lighting/mood: soft natural morning light, crisp but gentle shadows, clinical clarity without cold hospital mood.
Color palette: warm white, deep teal/sage accents in the background only, slate-gray bones, muted red and rose muscle fibers, ivory tendons, neutral graphite fine lines.
Strict constraints: anatomically plausible upper arm, elbow, forearm, wrist, and hand relationships; no extra fingers, no fused fingers, no duplicate elbows, no detached tendons, no impossible transparent overlays, no readable text, no letters, no numbers, no labels, no pseudo-text, no watermark, no logo, no gore, no blood, no organs, no exposed viscera, no injury, no surgery, no needles, no dramatic medical panic imagery, no bodybuilder posing, no aggressive bodybuilding aesthetic, no product placement, no stock-photo look.
