...
Composition/framing: landscape 16:9, two balanced anatomical views with generous margins, each view pelvis to just below knee. Use subtle non-text anchor dots or fine callout lines only if needed. No labels.
...
Strict constraints: anatomically plausible origin and insertion relationships, clean continuous tendons, no duplicate limbs, no extra bones, no impossible transparent overlays, no mirrored anatomy mistakes, no distorted pelvis, no detached muscles, no readable text, no letters, no numbers, no labels, no pseudo-text, no watermark, no logo, no gore, no blood, no organs, no exposed viscera, no injury, no surgery, no needles, no dramatic medical panic imagery, no bodybuilder posing, no aggressive bodybuilding aesthetic, no product placement, no stock-photo look.
